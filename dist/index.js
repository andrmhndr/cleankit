...
__export(index_exports, {
  ...
  debounce: () => debounce,
  useDialog: () => useDialog,
  useQueryParamsNext: () => useQueryParamsNext,
  useQueryParamsReact: () => useQueryParamsReact
});
...
`;
var DialogContext = (0, import_react4.createContext)(
  void 0
);
var DialogProvider = ({ children }) => {
  const [dialogs, setDialogs] = (0, import_react4.useState)([]);
  const openDialog = (0, import_react4.useCallback)((dialog) => {
    const id = (/* @__PURE__ */ new Date()).toISOString();
    return new Promise((resolve) => {
      setDialogs((prev2) => [...prev2, { ...dialog, id, resolve }]);
    });
  }, []);
  const closeDialog = (0, import_react4.useCallback)((id) => {
    if (!id) {
  ...
  const closeAllDialog = (0, import_react4.useCallback)(() => {
    setDialogs([]);
  }, []);
  const resolveDialog = (0, import_react4.useCallback)(
    (id, result) => {
  ...
  return /* @__PURE__ */ import_react4.default.createElement(DialogContext.Provider, { value: { openDialog, closeDialog, closeAllDialog } }, children, dialogs.map((dialog) => /* @__PURE__ */ import_react4.default.createElement(
    Overlay,
    {
      key: dialog.id,
      onClick: () => resolveDialog(dialog.id, null)
    },
    /* @__PURE__ */ import_react4.default.createElement(DialogBox, { onClick: (e) => e.stopPropagation() }, typeof dialog.content === "function" ? dialog.content(
      (result) => resolveDialog(dialog.id, result)
    ) : dialog.content ?? /* @__PURE__ */ import_react4.default.createElement(ButtonGroup, null, /* @__PURE__ */ import_react4.default.createElement(
      Button,
      {
...
var useDialog = () => {
  const context = (0, import_react5.useContext)(DialogContext);
  if (!context) {
...
var useQueryParamsNext = () => {
  ...
  const debounceMap = (0, import_react6.useRef)({});
  const getAll = () => {
...
var useQueryParamsReact = () => {
  ...
  const debounceMap = (0, import_react7.useRef)({});
